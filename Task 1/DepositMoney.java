...
public class DepositMoney extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String amountStr = req.getParameter("deposit_amount");
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/atm", "root", "Atish@1193");
                ...
                if (ps.executeUpdate() > 0) {
                    out.println("Dear " + username + "<h3 style='color:green;'>₹" + amount + " deposited successfully!</h3>");
                } else {
                    out.println("<h3 style='color:red;'>Deposit failed!</h3>");
                }
            }
        } catch (Exception e) {
